...
| البند | القيمة |
|---|---|
| آخر مزامنة مرجعية | 2026-05-01T08:15:02.0500938+03:00 |
| الفرع الحالي | `main` |
| آخر commit | `e8e9f3da8d6afa43e3fec05e64ffe83c03f40116` |
| حالة working tree | تحتوي تعديلات تنفيذية ضمن الجولة |
...
- تم تشغيل هجرات قاعدة البيانات على PostgreSQL مؤقت.
- تم اختبار التسجيل العادي وتكرار البريد والدخول العادي بكلمة صحيحة وخاطئة.
- تم اختبار التسجيل الجديد وبدء الدخول الجديد والتحقق الجديد بكلمة صحيحة وخاطئة.
- تم اختبار `/editor` و `/ui` على خادم واجهة محلي مبني.
- تم تشغيل فحوص النوع والتدقيق والبناء والاختبارات الموجهة للواجهة والخلفية.
