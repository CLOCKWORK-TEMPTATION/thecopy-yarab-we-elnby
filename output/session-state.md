...
| البند | القيمة |
|---|---|
| آخر مزامنة مرجعية | 2026-05-01T09:22:34.3547461+03:00 |
| الفرع الحالي | `main` |
| آخر commit | `b25c4641138ea168285a0194f3923e12f23b1c7f` |
| حالة working tree | تحتوي تعديلات تنفيذية غير ملتزمة |
...
- الموقع المنشور أعاد 500 قبل نشر التعديل، والإصلاح المحلي يتطلب نشر الخلفية حتى يظهر أثره هناك.
- لا توجد فجوة تشغيلية مفتوحة داخل الكود المحلي بعد تشغيل الهجرات والاختبارات والبناء.
