...
async function detectKnowledgeCandidate(
...
async function collectKnowledgeDiscoveryCandidates(): Promise<
  DiscoveryCandidate[]
> {
...
async function collectInvalidLocalKnowledgeDocs(): Promise<
  Map<string, string[]>
> {
