...
const KNOWLEDGE_SYSTEM_DEFINITIONS: KnowledgeSystemDefinition[] = [
  {
    ...
    components: [
      ...
      { kind: "embedding-generation", path: "scripts/agent/lib/code-memory/embedder.ts" },
    ...
    vectorStorePatterns: ["LanceDB", "lancedb", "Qdrant", "qdrant", "WORKSPACE-EMBEDDING-INDEX.json", ".agent-code-memory"],
    rerankerPatterns: [],
