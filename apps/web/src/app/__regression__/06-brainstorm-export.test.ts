...
describe("شبكة انحدار: brain-storm-ai — export buttons — بنية البيانات", () => {
...
describe("شبكة انحدار: brain-storm-ai — session history export", () => {
  beforeEach(() => {
    localStorage.clear();
  });
  ...
  it("حفظ جلسة موجودة يحدّثها بدل إضافة نسخة جديدة", () => {
    ...
    const updated = {
      session: createMockSession({ id: "dup-1", status: "completed" }),
      messages: createMockMessages(),
