...
const arabicMaleIndicators = [
  ...
  "هو", "له", "ابنه", "أخوه", "والده", "رجل", "الرجل", "السيد",
  "الشيخ", "الطفل", "الشاب", "الرجل العجوز",
];

const arabicFemaleIndicators = [
  "قالت", "ذهبت", "جاءت", "نظرت", "وقفت", "جلست", "خرجت", "دخلت",
  "هي", "لها", "ابنتها", "أختها", "والدتها", "امرأة", "المرأة", "السيدة",
  "الفتاة", "الأم", "البنت", "الطفلة",
];

const englishMaleIndicators = [
  "he", "him", "his", "man", "men", "boy", "father", "brother",
  "son", "husband", "mr.", "mr ", "sir", "guy", "gentleman",
];
...
const femaleNames = [
  "mary", "sarah", "fatima", "aisha", "maryam", "zahra", "layla", "noor", "hana", "sara",
  "امرأة", "فتاة", "بنت", "أم", "أخت",
];
