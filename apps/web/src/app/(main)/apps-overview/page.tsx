...
export default function AppsOverviewPage() {
  ...
  // تجميع التطبيقات المفعّلة حسب الفئة
  ...
  const getCategoryColor = (category: string) =>
    categoryColors[category] ?? "from-white/10 to-white/5";
    ...
    >
      ...
      <div className="max-w-7xl mx-auto mb-12">
        <div className="text-center mb-8">
          ...
          <p className="text-xl md:text-2xl text-white/68 mb-2">
      ...
      {/* شبكة التطبيقات مجمّعة حسب الفئة */}
      <div
                  ...
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2 text-white">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-sm text-white/55 font-normal">
                          {app.name}
                        </div>
                      </div>
                    </CardTitle>
      ...
      {/* قسم التطبيقات القادمة — حالة صادقة لا روابط مكسورة */}
              ...
              >
                <CardHeader>
                  <CardTitle className="flex items-center gap-2 text-white/40">
                    ...
                    <div className="flex-1">
                      <div className="text-xl">{app.nameAr}</div>
                      <div className="text-sm text-white/30 font-normal">
                        {app.name}
                      </div>
                    </div>
                  </CardTitle>
