  ...
  const analyzeSceneRhythm = useCallback(() => {
    ...
    setTimeout(() => {
      const analysis: SceneRhythmAnalysis = {
        ...
        monotonyAlerts: [
          { startPosition: 15, endPosition: 35, severity: "medium", description: "فترة طويلة من الإيقاع المتوسط دون تنويع كافٍ", suggestion: "أضف لحظة صمت درامي أو تغيير مفاجئ في نبرة الصوت لكسر الرتابة" },
          { startPosition: 55, endPosition: 65, severity: "low", description: "الحوار يميل للنمطية في هذا القسم", suggestion: "جرب تسريع إيقاع بعض الجمل أو إضافة وقفات استراتيجية" },
        ],
        comparisons: [
        ...
        emotionalSuggestions: [
          { segment: "يا ليلى، يا قمر الليل", currentEmotion: "شوق عادي", suggestedEmotion: "شوق ملتهب", technique: "تنفس عميق قبل النداء، ثم إخراج الكلمات بنفس طويل متصاعد", example: "ابدأ بهمس ثم تصاعد تدريجي: يا... ليـ...ـلى (مد الحروف مع تصاعد)" },
          { segment: "أنتِ نور عيني وروحي", currentEmotion: "إعلان مباشر", suggestedEmotion: "اكتشاف داخلي", technique: "كأنك تكتشف هذه الحقيقة للمرة الأولى أثناء الكلام", example: "توقف قصير بين 'عيني' و'روحي' كأنك تبحث عن الكلمة الأعمق" },
          { segment: "ماذا سنفعل؟", currentEmotion: "تساؤل بسيط", suggestedEmotion: "قلق ممزوج بأمل", technique: "اجعل السؤال معلقاً في الهواء، لا تنهيه بشكل حاسم", example: "ارفع نبرتك قليلاً في النهاية مع نظرة تنتظر الجواب" },
          { segment: "سأجد طريقة، مهما كانت الصعوبات", currentEmotion: "وعد عادي", suggestedEmotion: "عزم لا يتزعزع", technique: "أنزل صوتك قليلاً واجعله أكثر ثباتاً - صوت القرار", example: "سأجد (وقفة قصيرة مع نظرة مباشرة) طريقة... مهما كانت الصعوبات (بثبات)" },
        ],
        peakMoments: [
