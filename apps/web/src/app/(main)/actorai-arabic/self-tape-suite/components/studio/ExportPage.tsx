...
interface ExportPageProps {
  ...
  setExportSettings: (settings: ExportSettings | ((prev: ExportSettings) => ExportSettings)) => void;
        ...
        <Card className="bg-black/18 border-purple-500/30 bg-transparent">
          <CardHeader>
            ...
            <CardDescription className="text-purple-300">
              التصدير الحالي ينزل الملف الأصلي المسجل كما التقطه المتصفح،
              مع استخدام الاسم المنظف وبيانات السليت داخل اسم الملف.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent className="border-purple-500/30 bg-black/14">
                  <SelectItem value="casting" className="text-white">Casting</SelectItem>
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent className="border-purple-500/30 bg-black/14">
                  <SelectItem value="webm" className="text-white">WebM</SelectItem>
                  <SelectItem value="mp4" className="text-white">MP4</SelectItem>
                  <SelectItem value="mov" className="text-white">MOV</SelectItem>
                </SelectContent>
              </Select>
            </div>
            ...
            <div className="rounded-xl bg-black/14 p-4">
              ...
              {exportSettings.includeSlate && (
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <Label className="text-sm text-purple-300">مدة السليت: {exportSettings.slateDuration} ثوان</Label>
                    <Slider
      ...
      <CardSpotlight className="overflow-hidden rounded-[22px] bg-black/18 border-purple-500/30">
        <Card className="bg-black/18 border-purple-500/30 bg-transparent">
          <CardHeader>
            ...
            <CardDescription className="text-purple-300">
              التسجيلات التي تحتوي على ملف فيديو حي فقط ستكون قابلة
              للتنزيل.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            {availableTakes.map((take) => {
              ...
              return (
                <div key={take.id} className="rounded-xl border border-purple-500/20 bg-black/14 p-4">
                  <div className="flex items-center justify-between gap-4">
                    <div>
                      <h4 className="font-medium text-white">{take.name}</h4>
                      <p className="text-sm text-white/55">{formatTime(take.duration)} • {take.score ?? 0}%</p>
                    </div>
                  ...
                  {!canDownload && (
                    <p className="mt-3 text-sm text-yellow-300">
                      هذا التسجيل محفوظ كمرجع وصفي فقط بعد إعادة التحميل،
                      لذا لا يملك ملف فيديو صالحاً للتنزيل.
                    </p>
                  )}
                </div>
              );
