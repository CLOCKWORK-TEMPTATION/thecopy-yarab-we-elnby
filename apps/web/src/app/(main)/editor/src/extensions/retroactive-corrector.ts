 ...
 * المضافة تلقائيًا من ensureCharacterTrailingColon، لأن الحوار الحقيقي
 * لا يحمل علامة الشخصية في ذيله. عدم نزعها يُسرّب أثر التصنيف الخاطئ
 * إلى ناتج المستخدم النهائي.
 */
