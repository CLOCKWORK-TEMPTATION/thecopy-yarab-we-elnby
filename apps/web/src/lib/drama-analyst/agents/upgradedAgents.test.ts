...
describe("Upgraded Agents — Agent Registration", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
...
describe("Upgraded Agents — Agent Configuration", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
...
describe("Upgraded Agents — Agent Execution", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it("should execute character voice agent task successfully", async () => {
    const result = await executeAgentTask(TaskType.CHARACTER_VOICE, testInput);
...
describe("Upgraded Agents — Batch Execution", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it("should handle partial failures in batch execution", async () => {
    const tasks = [
      {
        taskType: TaskType.COMPLETION,
        input: { input: "مهمة صحيحة", options: {}, context: {} },
      },
      {
        taskType: 9999 as TaskType,
        input: { input: "مهمة خاطئة", options: {}, context: {} },
      },
    ];
...
describe("Upgraded Agents — Statistics and Output", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
...
describe("Upgraded Agents — Standard Pattern Integration", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
...
describe("Individual Agent Tests — CompletionAgent", () => {
...
describe("Individual Agent Tests — CreativeAgent", () => {
...
describe("Individual Agent Tests — CharacterVoiceAgent", () => {
