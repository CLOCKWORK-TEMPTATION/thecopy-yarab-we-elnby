...
function makeAgent() {
  const agent = new RhythmMappingAgent();
  vi.clearAllMocks();
  return agent;
}

describe("RhythmMappingAgent — Configuration", () => {
...
describe("RhythmMappingAgent — Success Path", () => {
  let agent: RhythmMappingAgent;
...
describe("RhythmMappingAgent — Low Confidence Path", () => {
  let agent: RhythmMappingAgent;
...
describe("RhythmMappingAgent — Hallucination Detection", () => {
  let agent: RhythmMappingAgent;
...
describe("RhythmMappingAgent — Post-Processing", () => {
  let agent: RhythmMappingAgent;
...
describe("RhythmMappingAgent — Error Handling", () => {
  let agent: RhythmMappingAgent;
...
describe("RhythmMappingAgent — Advanced Options", () => {
  let agent: RhythmMappingAgent;
...
describe("RhythmMappingAgent — Rhythm Patterns Analysis", () => {
  let agent: RhythmMappingAgent;
...
describe("RhythmMappingAgent — Integration with Standard Pattern", () => {
  let agent: RhythmMappingAgent;
