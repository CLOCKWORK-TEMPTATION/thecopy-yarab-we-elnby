...
import { SUSPICION_SCORE_THRESHOLD, FINAL_REVIEW_SCORE_THRESHOLD, logger } from "./suspicion-probe-constants.mjs";
 ...
 */
export function countSuspicionCases(karankResult, threshold = SUSPICION_SCORE_THRESHOLD) {
